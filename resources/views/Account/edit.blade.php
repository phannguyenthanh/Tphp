    ...
    <section class="content">
      <div class="row">
        ...
        @if(session('alert'))
            ...
            <form class="form-horizontal" action="/Admin/Account/edit/{{$account->id}}" method="post">
            <input type="hidden"  name="_token" value="{{csrf_token()}}" >
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="name" class="form-control" id="inputEmail3" placeholder="Tên" value="{{$account->name}}" >
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="date" name="birthday" class="form-control" id="inputEmail3" placeholder=""  value="{{$account->birthday}}"  >
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="addr" class="form-control" id="inputPassword3" placeholder="Địa chỉ"  value="{{$account->addr}}" >
                  </div>
                </div>
